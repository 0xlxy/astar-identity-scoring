...
export default function ScoreMeter() {
  ...
  return (
    <div style={{ backgroundColor: 'transparent', height: 135, width: 180 }}>
      <canvas id='myCanvas' style={{ position: 'relative', top: -85, left: -93 }} height='350' width='400'></canvas>
      <p style={{ fontWeight: 600, fontSize: 24, position: 'relative', top: -280, left: 65 }}>658</p>
      <p style={{ fontSize: 8, position: 'relative', top: -280, left: 59, borderRadius: '6px 6px 0 0', backgroundColor: '#647699', color: '#F9F9FF', width: 'min-content', whiteSpace: 'nowrap', padding: '2px 5px' }}>14 Nov 2022</p>
    </div>
  )
}
